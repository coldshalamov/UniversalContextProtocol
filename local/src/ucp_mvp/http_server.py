"""
HTTP/SSE Server for UCP Local MVP.
...
from ucp.telemetry import get_prometheus_metrics
...
class UCPHttpServer:
    ...
    def _register_routes(self, app: FastAPI) -> None:
        ...
        async def get_metrics():
            ...
            """
            return Response(
                content=self._prometheus_metrics.get_all_metrics(),
...
def create_http_app(config_path: str | None = None) -> FastAPI:
    """
    Factory function to create HTTP app.
...
# Import Response from starlette for metrics endpoint
from starlette.responses import Response
